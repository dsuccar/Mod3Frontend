...
function stringFixer(string){
  ...
  const string7 = string6.replace(/Llanfair&shy;/g, "Llanfair") //string16 to string23 is for the long welsh name. putting them all together inside one //g made the result look strange
  ...
  const string23 = string22.replace(/&iacute;/g, "í")
  const string24 = string23.replace(/&;/g, "&")
  return string24
}
